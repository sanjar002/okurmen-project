            ...
            <Link to="/course">
              <div class="post-item-wrap">
                <a href="" class="post-link">
                  ...
                  <p class="post-content">
                    {t(
                      "UX / UI веб-дизайн индустриясын үйрөнүү үчүн орто эсеп менен 5-8 ай талап кылынат. Жакшы адис болуу үчүн биринчи кезекте күчтүү каалоо, чыгармачылык, чыгармачылык, күчтүү фантазия болушу керек. Бул сүрөттө максатка тезирээк жана оңой жетүү үчүн UX / UI веб-дизайнын үйрөнүүнү каалагандар үчүн атайын жол картасы түзүлдү."
                    )}
                  </p>
                </a>
              </div>
